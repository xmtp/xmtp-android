...
public inline fun messageV1(block: com.xmtp.message_contents.MessageV1Kt.Dsl.() -> kotlin.Unit): com.xmtp.message_contents.MessageV1 =
  com.xmtp.message_contents.MessageV1Kt.Dsl._create(com.xmtp.message_contents.MessageV1.newBuilder()).apply { block() }._build()
/**
 * ```
 * Message is the top level protocol element
 * ```
 *
 * Protobuf type `xmtp.message_contents.MessageV1`
 */
public object MessageV1Kt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.xmtp.message_contents.MessageV1.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.xmtp.message_contents.MessageV1.Builder): Dsl = Dsl(builder)
    }
...
public val com.xmtp.message_contents.MessageV1OrBuilder.ciphertextOrNull: com.xmtp.message_contents.Ciphertext?
