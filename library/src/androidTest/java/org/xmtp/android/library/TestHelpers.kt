...
class Fixtures {
    ...
    val daveAccount = PrivateKeyBuilder()
    ...
    var dave: PrivateKey = daveAccount.getPrivateKey()
    var daveClient: Client =
        runBlocking { Client().create(account = daveAccount, options = clientOptions) }
}
