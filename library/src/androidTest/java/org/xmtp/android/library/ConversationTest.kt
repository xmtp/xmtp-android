...
//        val conversation = runBlocking { bobClient.conversations.newConversation(alice.walletAddress) }
...
//            )
//        }
//        var conversation = runBlocking { aliceClient.conversations.newConversation(bob.walletAddress) }
...
//        val bobConversation = runBlocking { bobClient.conversations.newConversation(aliceWallet.address) }
//        val aliceConversation = runBlocking { aliceClient.conversations.newConversation(bobWallet.address) }
//
