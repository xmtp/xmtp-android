...
public inline fun subscribeRequest(block: org.xmtp.android.library.push.SubscribeRequestKt.Dsl.() -> kotlin.Unit): org.xmtp.android.library.push.Service.SubscribeRequest =
  org.xmtp.android.library.push.SubscribeRequestKt.Dsl._create(org.xmtp.android.library.push.Service.SubscribeRequest.newBuilder()).apply { block() }._build()
public object SubscribeRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: org.xmtp.android.library.push.Service.SubscribeRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: org.xmtp.android.library.push.Service.SubscribeRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): org.xmtp.android.library.push.Service.SubscribeRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun org.xmtp.android.library.push.Service.SubscribeRequest.copy(block: org.xmtp.android.library.push.SubscribeRequestKt.Dsl.() -> kotlin.Unit): org.xmtp.android.library.push.Service.SubscribeRequest =
  org.xmtp.android.library.push.SubscribeRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
