...
val ContentTypeText = ContentTypeIdBuilder.builderFromAuthorityId("xmtp.org", "text", versionMajor = 1, versionMinor = 0)
typealias T = String

data class TextCodec(override var contentType: ContentTypeId = ContentTypeText): ContentCodec {
