...
data class Conversations(
    ...
    enum class ListConversationOrderBy {
        CREATED_AT,
        LAST_ACTIVITY;
    }

    fun ListConversationOrderBy.toFfi(): FfiGroupQueryOrderBy {
        return when (this) {
            ListConversationOrderBy.CREATED_AT -> FfiGroupQueryOrderBy.CREATED_AT
            ListConversationOrderBy.LAST_ACTIVITY -> FfiGroupQueryOrderBy.LAST_ACTIVITY
        }
    }
    ...
    fun listGroups(
        ...
        orderBy: ListConversationOrderBy = ListConversationOrderBy.LAST_ACTIVITY,
    ): List<Group> {
    ...
    fun allPushTopics(): List<String> {
        val conversations = ffiConversations.list(
            FfiListConversationsOptions(
                ...
                null,
                null,
                ListConversationOrderBy.CREATED_AT.toFfi(),
                null,
                null,
