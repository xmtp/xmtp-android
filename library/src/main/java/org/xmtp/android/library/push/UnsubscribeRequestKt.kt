...
public inline fun unsubscribeRequest(block: org.xmtp.android.library.push.UnsubscribeRequestKt.Dsl.() -> kotlin.Unit): org.xmtp.android.library.push.Service.UnsubscribeRequest =
  org.xmtp.android.library.push.UnsubscribeRequestKt.Dsl._create(org.xmtp.android.library.push.Service.UnsubscribeRequest.newBuilder()).apply { block() }._build()
public object UnsubscribeRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: org.xmtp.android.library.push.Service.UnsubscribeRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: org.xmtp.android.library.push.Service.UnsubscribeRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): org.xmtp.android.library.push.Service.UnsubscribeRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun org.xmtp.android.library.push.Service.UnsubscribeRequest.copy(block: org.xmtp.android.library.push.UnsubscribeRequestKt.Dsl.() -> kotlin.Unit): org.xmtp.android.library.push.Service.UnsubscribeRequest =
  org.xmtp.android.library.push.UnsubscribeRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
