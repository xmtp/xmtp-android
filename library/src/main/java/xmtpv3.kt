...
internal interface _UniFFILib : Library {
    ...
    fun uniffi_xmtpv3_fn_method_ffigroup_add_admin(`ptr`: Pointer,`address`: RustBuffer.ByValue,
    ): Pointer
    ...
    fun uniffi_xmtpv3_fn_method_ffigroup_admin_list(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_xmtpv3_fn_method_ffigroup_group_permissions(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): Pointer
    ...
    fun uniffi_xmtpv3_fn_method_ffigroup_is_admin(`ptr`: Pointer,`accountAddress`: RustBuffer.ByValue,_uniffi_out_err: RustCallStatus, 
    ): Byte
    fun uniffi_xmtpv3_fn_method_ffigroup_is_super_admin(`ptr`: Pointer,`accountAddress`: RustBuffer.ByValue,_uniffi_out_err: RustCallStatus, 
    ): Byte
    ...
    fun uniffi_xmtpv3_fn_method_ffigroup_remove_admin(`ptr`: Pointer,`address`: RustBuffer.ByValue,
    ): Pointer
    ...
    fun uniffi_xmtpv3_fn_method_ffigroup_super_admin_list(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_xmtpv3_fn_free_ffigrouppermissions(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): Unit
    fun uniffi_xmtpv3_fn_method_ffigrouppermissions_policy_type(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
...
private fun uniffiCheckApiChecksums(lib: _UniFFILib) {
    ...
    if (lib.uniffi_xmtpv3_checksum_method_ffigroup_add_admin() != 59156.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_xmtpv3_checksum_method_ffigroup_admin_list() != 12779.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_xmtpv3_checksum_method_ffigroup_group_permissions() != 48780.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_xmtpv3_checksum_method_ffigroup_is_admin() != 52576.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_xmtpv3_checksum_method_ffigroup_is_super_admin() != 32952.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_xmtpv3_checksum_method_ffigroup_remove_admin() != 44690.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_xmtpv3_checksum_method_ffigroup_super_admin_list() != 5618.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface FfiGroupInterface {
    @Throws(GenericException::class)
    suspend fun `addAdmin`(`address`: String)@Throws(GenericException::class)
    suspend fun `addMembers`(`accountAddresses`: List<String>)@Throws(GenericException::class)
    fun `addedByAddress`(): String@Throws(GenericException::class)
    fun `adminList`(): List<String>
    ...
    fun `groupName`(): String@Throws(GenericException::class)
    ...
    fun `isAdmin`(`accountAddress`: String): Boolean@Throws(GenericException::class)
    fun `isSuperAdmin`(`accountAddress`: String): Boolean@Throws(GenericException::class)
    ...
    suspend fun `removeAdmin`(`address`: String)@Throws(GenericException::class)
    ...
    fun `superAdminList`(): List<String>@Throws(GenericException::class)
...
class FfiGroup(
    ...
    @Throws(GenericException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `addAdmin`(`address`: String) {
        return uniffiRustCallAsync(
            callWithPointer { thisPtr ->
                _UniFFILib.INSTANCE.uniffi_xmtpv3_fn_method_ffigroup_add_admin(
                    thisPtr,
    ...
    @Throws(GenericException::class)override fun `adminList`(): List<String> =
        callWithPointer {
    rustCallWithError(GenericException) { _status ->
    _UniFFILib.INSTANCE.uniffi_xmtpv3_fn_method_ffigroup_admin_list(it,
    ...
    @Throws(GenericException::class)override fun `groupPermissions`(): FfiGroupPermissions =
        callWithPointer {
    rustCallWithError(GenericException) { _status ->
    _UniFFILib.INSTANCE.uniffi_xmtpv3_fn_method_ffigroup_group_permissions(it,
        
        _status)
}
        }.let {
            FfiConverterTypeFfiGroupPermissions.lift(it)
        }
    ...
    @Throws(GenericException::class)override fun `isAdmin`(`accountAddress`: String): Boolean =
        callWithPointer {
    rustCallWithError(GenericException) { _status ->
    _UniFFILib.INSTANCE.uniffi_xmtpv3_fn_method_ffigroup_is_admin(it,
    ...
    @Throws(GenericException::class)override fun `isSuperAdmin`(`accountAddress`: String): Boolean =
        callWithPointer {
    rustCallWithError(GenericException) { _status ->
    _UniFFILib.INSTANCE.uniffi_xmtpv3_fn_method_ffigroup_is_super_admin(it,
        FfiConverterString.lower(`accountAddress`),
        _status)
}
        }.let {
    ...
    @Throws(GenericException::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `removeAdmin`(`address`: String) {
        return uniffiRustCallAsync(
            callWithPointer { thisPtr ->
                _UniFFILib.INSTANCE.uniffi_xmtpv3_fn_method_ffigroup_remove_admin(
                    thisPtr,
                    FfiConverterString.lower(`address`),
                )
            },
    ...
    @Throws(GenericException::class)override fun `superAdminList`(): List<String> =
        callWithPointer {
    rustCallWithError(GenericException) { _status ->
    _UniFFILib.INSTANCE.uniffi_xmtpv3_fn_method_ffigroup_super_admin_list(it,
...
class FfiGroupPermissions(
    ...
    @Throws(GenericException::class)override fun `policyType`(): GroupPermissions =
        callWithPointer {
    rustCallWithError(GenericException) { _status ->
    _UniFFILib.INSTANCE.uniffi_xmtpv3_fn_method_ffigrouppermissions_policy_type(it,
...
enum class GroupAction {
    ADD_MEMBER,REMOVE_MEMBER,ADD_ADMIN,REMOVE_ADMIN,ADD_SUPER_ADMIN,REMOVE_SUPER_ADMIN,UPDATE_GROUP_NAME;
    companion object
}

public object FfiConverterTypeGroupAction: FfiConverterRustBuffer<GroupAction> {
    override fun read(buf: ByteBuffer) = try {
        GroupAction.values()[buf.getInt() - 1]
    } catch (e: IndexOutOfBoundsException) {
        throw RuntimeException("invalid enum value, something is very wrong!!", e)
    }

    override fun allocationSize(value: GroupAction) = 4

    override fun write(value: GroupAction, buf: ByteBuffer) {
        buf.putInt(value.ordinal + 1)
    }
}
...
enum class GroupActionPermission {
    ALL_MEMBERS,ADMINS_OR_SUPER_ADMINS_ONLY,SUPER_ADMINS_ONLY;
    companion object
}

public object FfiConverterTypeGroupActionPermission: FfiConverterRustBuffer<GroupActionPermission> {
    override fun read(buf: ByteBuffer) = try {
        GroupActionPermission.values()[buf.getInt() - 1]
    } catch (e: IndexOutOfBoundsException) {
        throw RuntimeException("invalid enum value, something is very wrong!!", e)
    }

    override fun allocationSize(value: GroupActionPermission) = 4

    override fun write(value: GroupActionPermission, buf: ByteBuffer) {
        buf.putInt(value.ordinal + 1)
    }
}
